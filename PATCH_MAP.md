...
*No **login-gate** patches yet — P1–P7 below are still pre-registered. The rows*
*that follow are **build patches** (prefix `B`), landed in T0.3 to make the*
*client compile at all on a current macOS toolchain.*
